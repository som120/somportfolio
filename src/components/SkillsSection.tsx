  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: 'Flutter Widgets', level: 75, color: 'from-green-400 to-green-600' }
      ]
    },
    {
      title: 'Backend',
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Firebase Console', level: 82, color: 'from-blue-600 to-blue-800' },
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 opacity-60">
            {[
              'Flutter', 'Firebase', 'Appwrite', 'Git', 'Python', 'Dart', 
              'Java', 'Figma', 'AWS','GCP', 'SQL'
            ].map((tech, index) => (
              <motion.span
                key={tech}
